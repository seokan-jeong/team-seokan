...
export declare function createBuiltinSkills(context: PluginContext): SkillConfig[];
export { createUltraworkSkill, createRalphSkill, createAutopilotSkill, createPlanSkill, createAnalyzeSkill, createDeepsearchSkill, createGitMasterSkill, createFrontendUiUxSkill, createHelpSkill, createCancelSkill, createMemoriesSkill, createForgetSkill, createLearnSkill, createDebateSkill, };
